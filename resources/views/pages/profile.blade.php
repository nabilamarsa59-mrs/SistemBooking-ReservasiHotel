    ...
    <div class="bg-[#ece6da] min-h-screen px-10 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="border border-gray-400 bg-white p-6 flex flex-col items-center text-center">
                ...
                <div
                    class="w-32 h-32 rounded-full border border-gray-400 flex items-center justify-center bg-[#f8f8f8] mb-4 overflow-hidden">
            ...
            <div class="lg:col-span-2 border border-gray-400 bg-white">
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
                        ...
                        <input disabled name="nama" type="text" value="{{ $profile['nama'] }}"
                            class="profile-input md:col-span-2 rounded-lg border border-gray-400 bg-[#f8f8f8] px-4 py-3">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
                        <label class="text-[18px] font-semibold text-[#243b53]">Email</label>
                        <input disabled name="email" type="email" value="{{ $profile['email'] }}"
                            class="profile-input md:col-span-2 rounded-lg border border-gray-400 bg-[#f8f8f8] px-4 py-3">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
                        <label class="text-[18px] font-semibold text-[#243b53]">No Telepon</label>
                        <input disabled name="telepon" type="text" value="{{ $profile['telepon'] }}"
                            class="profile-input md:col-span-2 rounded-lg border border-gray-400 bg-[#f8f8f8] px-4 py-3">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
                        <label class="text-[18px] font-semibold text-[#243b53]">Kata Sandi</label>
                        <input disabled name="password" type="password" value="{{ $profile['password'] }}"
                            class="profile-input md:col-span-2 rounded-lg border border-gray-400 bg-[#f8f8f8] px-4 py-3">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
                        <label class="text-[18px] font-semibold text-[#243b53]">Jenis Kelamin</label>
                        <input disabled name="gender" type="text" value="{{ $profile['gender'] }}"
                            class="profile-input md:col-span-2 rounded-lg border border-gray-400 bg-[#f8f8f8] px-4 py-3">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-4">
                        <label class="text-[18px] font-semibold text-[#243b53]">Alamat</label>
                        <input disabled name="alamat" type="text" value="{{ $profile['alamat'] }}"
                            class="profile-input md:col-span-2 rounded-lg border border-gray-400 bg-[#f8f8f8] px-4 py-3">
                    </div>

                    <div class="pt-4 flex justify-center">
                        <button type="button" onclick="saveProfile()" id="saveBtn" disabled
